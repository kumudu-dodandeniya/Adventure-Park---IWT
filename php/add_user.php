...
<div class="add_user">
   <h1>Add New User <span><a href = "read.php"> Back to user list </a></span></h1>
    ...
    <form  action = " <?php htmlspecialchars($_SERVER["PHP_SELF"])?>"  method = post >
        ...
        <input type = "text" name = "Email"  pattern = "[a-zA-z0-9._%+-#*]+@[a-z0-9]+\.[a-z]{2,3}" required><br>

		<lable> Mobile Number </lable><br>
		<input type = "text" name = "Mobile"   pattern = "[0-9]{10}" required><br>
...
$sql = "INSERT INTO customer(first_name,last_name,email,mobile,password)VALUES('$first_name','$last_name', '$email','$mobile', '$password'  )";
